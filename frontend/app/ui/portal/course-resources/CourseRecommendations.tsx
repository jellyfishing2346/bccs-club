...
// Define a list of recommended course codes (update this list as needed)
const recommendedCourseCodes = [
    "CISC 3160", // Programming Languages
    "CISC 3171", // Introduction to Software Engineering
...
// Filter for recommended upper-level CS electives
const filteredCourses = courseData.courses.filter(course =>
    recommendedCourseCodes.includes(course.course_code)
);
    ...
    <div className="mx-auto max-w-7xl px-6 lg:px-8 py-8">
      <div className="mx-auto max-w-4xl divide-y divide-gray-900/10">
        <h2 className="text-2xl font-bold leading-10 tracking-tight text-gray-900">
          Recommended CIS Course Electives
        </h2>
